$(function() {
	...
	/*---Scroling ---*/
	//P-scroll
	new PerfectScrollbar('.scroll-widget', {
...
gradientStroke1.addColorStop(0, hexToRgba(myVarVal, 0.8) ||'rgba(85, 56, 171, 0.8)');
gradientStroke1.addColorStop(1, hexToRgba(myVarVal, 0.2) ||'rgba(85, 56, 171, 0.2) ');
